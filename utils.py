...
test_ids = ['5', '21', '15', '30']
# train_ids = ['1', '3', '23', '26', '7', '11', '13', '28', '17', '32', '34', '37', '30']
# test_ids = ['5', '21', '15']
DATASET = 'Vaihingen'
Stride_Size = 32
...
whu_label = ['background', 'farmland', 'city', 'village', 'water', 'forest', 'road', 'others']
...
class WHU_OPT_SARDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.img_sar_transform is not None:
            ...
            img_opt = self.img_opt_transform(img_opt)[:3, :, :]
